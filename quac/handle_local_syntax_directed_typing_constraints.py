...
def handle_local_syntax_directed_typing_constraints(
    ...
    node_to_definition_node_mapping: typing.Mapping[ast.AST, ast.AST],
    ...
    add_relation_callback: typing.Callable[[ast.AST, ast.AST, RelationType, typing.Optional[object]], typing.Any],
    ...
    def update_runtime_terms_of_definition_node(node: ast.AST, runtime_terms: typing.Iterable[RuntimeTerm]):
        nonlocal node_to_definition_node_mapping
    ...
    def handle_local_syntax_directed_typing_constraints_callback(
        ...
        # ast.Call(func, args, keywords, starargs, kwargs)
            ...
            if contains_starred_arguments_or_keywords:              
                ...
                dummy_node_representing_all_parameters = ast.AST()
