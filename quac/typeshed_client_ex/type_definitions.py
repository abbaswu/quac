...
def to_runtime_class(typeshed_class: TypeshedClass) -> type | None:
...
class TypeshedFunctionDefinition:
    ...
    def __init__(
            ...
            vararg_type_annotation: TypeshedTypeAnnotation | None,
            kwonlyargs_name_to_type_annotation_dict: dict[str, TypeshedTypeAnnotation],
            kwarg_type_annotation: TypeshedTypeAnnotation | None,
        ...
        self.vararg_type_annotation: TypeshedTypeAnnotation | None = vararg_type_annotation
        self.kwonlyargs_name_to_type_annotation_dict: dict[
            str, TypeshedTypeAnnotation] = kwonlyargs_name_to_type_annotation_dict
        self.kwarg_type_annotation: TypeshedTypeAnnotation | None = kwarg_type_annotation
