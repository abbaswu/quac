...
class Client:
    ...
    def __init__(self):
        ...
        typeshed: Path = parent / 'typeshed' / 'stdlib'
        ...
        self.module_name_to_module_stub_names_dict_or_none: dict[
            str,
            dict[str, typeshed_client.NameInfo] | None
        ] = dict()
        ...
        # Used for creating RecusiveUnions
    ...
    def get_module_stub_names_dict_or_none(self, module_name: str) -> dict[str, typeshed_client.NameInfo] | None:
    ...
    def recursively_parse_ast_tuple_ast_list(
        self,
        module_name: str,
        node: typing.Union[ast.Tuple, ast.List]
    ) -> Generator[TypeshedTypeAnnotation, None, None]:
        for elt in node.elts:
            if isinstance(elt, typing.Union[ast.Tuple, ast.List]):
    ...
    def parse_global_function_or_staticmethod_ast_function_def_to_definition(
            self,
            global_function_or_concrete_class: TypeshedFunction | TypeshedClass,
            function_def: ast.FunctionDef | ast.AsyncFunctionDef
    ) -> TypeshedFunctionDefinition:
