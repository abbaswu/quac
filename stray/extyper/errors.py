...
class Errors:
    ...
    def __init__(self,
                 ...
                 many_errors_threshold: int = -1, cscope=None, single_incompatible=None) -> None:
        ...
        self.cscope = cscope or {}
        if single_incompatible is None:
    ...
    def copy(self) -> 'Errors':
        new = Errors(self.show_error_context,
                     ...
                     self.many_errors_threshold, cscope = self.cscope, single_incompatible = self.single_incompatible)
        new.file = self.file
