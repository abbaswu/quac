...
from extyper.types import (
    MaybeTypes, Type, AnyType, CallableType, Overloaded, TupleType, TypedDictType, LiteralType,
...
class TypeVisitor(Generic[T]):
    ...
    @abstractmethod
    def visit_maybe_type(self, t: UnionType) -> T:
        pass
...
class TypeTranslator(TypeVisitor[Type]):
    ...
    def visit_maybe_type(self, t: MaybeTypes) -> Type:
        return MaybeTypes(self.translate_types(t.items), t.line, t.column)
