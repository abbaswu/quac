...
from extyper.util import short_type, IdMapper
...
class StrConv(NodeVisitor[str]):
    ...
    def dump(self, nodes: Sequence[object], obj: 'extyper.nodes.Context') -> str:
    ...
    def func_helper(self, o: 'extyper.nodes.FuncItem') -> List[object]:
        ...
        anonymous functions.
        """
        args: List[Union[extyper.nodes.Var, Tuple[str, List[extyper.nodes.Node]]]] = []
        extra: List[Tuple[str, List[extyper.nodes.Var]]] = []
        for arg in o.arguments:
            kind: extyper.nodes.ArgKind = arg.kind
            if kind.is_required():
                args.append(arg.variable)
            elif kind.is_optional():
                assert arg.initializer is not None
                args.append(('default', [arg.variable, arg.initializer]))
            elif kind == extyper.nodes.ARG_STAR:
                extra.append(('VarArg', [arg.variable]))
            elif kind == extyper.nodes.ARG_STAR2:
    ...
    def visit_mypy_file(self, o: 'extyper.nodes.MypyFile') -> str:
    ...
    def visit_import(self, o: 'extyper.nodes.Import') -> str:
        a = []
    ...
    def visit_import_from(self, o: 'extyper.nodes.ImportFrom') -> str:
        a = []
    ...
    def visit_import_all(self, o: 'extyper.nodes.ImportAll') -> str:
        return 'ImportAll:{}({})'.format(o.line, "." * o.relative + o.id)

    # Definitions

    def visit_func_def(self, o: 'extyper.nodes.FuncDef') -> str:
        a = self.func_helper(o)
        a.insert(0, o.name)
        arg_kinds = {arg.kind for arg in o.arguments}
        if len(arg_kinds & {extyper.nodes.ARG_NAMED, extyper.nodes.ARG_NAMED_OPT}) > 0:
    ...
    def visit_overloaded_func_def(self, o: 'extyper.nodes.OverloadedFuncDef') -> str:
        a: Any = o.items[:]
        if o.type:
            a.insert(0, o.type)
        if o.impl:
    ...
    def visit_class_def(self, o: 'extyper.nodes.ClassDef') -> str:
    ...
    def visit_var(self, o: 'extyper.nodes.Var') -> str:
        lst = ''
    ...
    def visit_global_decl(self, o: 'extyper.nodes.GlobalDecl') -> str:
        return self.dump([o.names], o)

    def visit_nonlocal_decl(self, o: 'extyper.nodes.NonlocalDecl') -> str:
        return self.dump([o.names], o)

    def visit_decorator(self, o: 'extyper.nodes.Decorator') -> str:
        return self.dump([o.var, o.decorators, o.func], o)

    # Statements

    def visit_block(self, o: 'extyper.nodes.Block') -> str:
        return self.dump(o.body, o)

    def visit_expression_stmt(self, o: 'extyper.nodes.ExpressionStmt') -> str:
        return self.dump([o.expr], o)

    def visit_assignment_stmt(self, o: 'extyper.nodes.AssignmentStmt') -> str:
        a: List[Any] = []
        if len(o.lvalues) > 1:
            a = [('Lvalues', o.lvalues)]
        else:
    ...
    def visit_operator_assignment_stmt(self, o: 'extyper.nodes.OperatorAssignmentStmt') -> str:
        return self.dump([o.op, o.lvalue, o.rvalue], o)

    def visit_while_stmt(self, o: 'extyper.nodes.WhileStmt') -> str:
        a: List[Any] = [o.expr, o.body]
        if o.else_body:
            a.append(('Else', o.else_body.body))
        return self.dump(a, o)

    def visit_for_stmt(self, o: 'extyper.nodes.ForStmt') -> str:
        a: List[Any] = []
        if o.is_async:
            a.append(('Async', ''))
        a.append(o.index)
    ...
    def visit_return_stmt(self, o: 'extyper.nodes.ReturnStmt') -> str:
        return self.dump([o.expr], o)

    def visit_if_stmt(self, o: 'extyper.nodes.IfStmt') -> str:
        a: List[Any] = []
    ...
    def visit_break_stmt(self, o: 'extyper.nodes.BreakStmt') -> str:
        return self.dump([], o)

    def visit_continue_stmt(self, o: 'extyper.nodes.ContinueStmt') -> str:
        return self.dump([], o)

    def visit_pass_stmt(self, o: 'extyper.nodes.PassStmt') -> str:
        return self.dump([], o)

    def visit_raise_stmt(self, o: 'extyper.nodes.RaiseStmt') -> str:
        return self.dump([o.expr, o.from_expr], o)

    def visit_assert_stmt(self, o: 'extyper.nodes.AssertStmt') -> str:
        if o.msg is not None:
            return self.dump([o.expr, o.msg], o)
        else:
            return self.dump([o.expr], o)

    def visit_await_expr(self, o: 'extyper.nodes.AwaitExpr') -> str:
        return self.dump([o.expr], o)

    def visit_del_stmt(self, o: 'extyper.nodes.DelStmt') -> str:
        return self.dump([o.expr], o)

    def visit_try_stmt(self, o: 'extyper.nodes.TryStmt') -> str:
        a: List[Any] = [o.body]
    ...
    def visit_with_stmt(self, o: 'extyper.nodes.WithStmt') -> str:
        a: List[Any] = []
        if o.is_async:
            a.append(('Async', ''))
        for i in range(len(o.expr)):
    ...
    def visit_print_stmt(self, o: 'extyper.nodes.PrintStmt') -> str:
        a: List[Any] = o.args[:]
        if o.target:
    ...
    def visit_exec_stmt(self, o: 'extyper.nodes.ExecStmt') -> str:
    ...
    def visit_int_expr(self, o: 'extyper.nodes.IntExpr') -> str:
        return 'IntExpr({})'.format(o.value)

    def visit_str_expr(self, o: 'extyper.nodes.StrExpr') -> str:
        return 'StrExpr({})'.format(self.str_repr(o.value))

    def visit_bytes_expr(self, o: 'extyper.nodes.BytesExpr') -> str:
        return 'BytesExpr({})'.format(self.str_repr(o.value))

    def visit_unicode_expr(self, o: 'extyper.nodes.UnicodeExpr') -> str:
    ...
    def visit_float_expr(self, o: 'extyper.nodes.FloatExpr') -> str:
        return 'FloatExpr({})'.format(o.value)

    def visit_complex_expr(self, o: 'extyper.nodes.ComplexExpr') -> str:
        return 'ComplexExpr({})'.format(o.value)

    def visit_ellipsis(self, o: 'extyper.nodes.EllipsisExpr') -> str:
        return 'Ellipsis'

    def visit_star_expr(self, o: 'extyper.nodes.StarExpr') -> str:
        return self.dump([o.expr], o)

    def visit_name_expr(self, o: 'extyper.nodes.NameExpr') -> str:
        pretty = self.pretty_name(o.name, o.kind, o.fullname,
                                  o.is_inferred_def or o.is_special_form,
                                  o.node)
        if isinstance(o.node, extyper.nodes.Var) and o.node.is_final:
    ...
    def pretty_name(self, name: str, kind: Optional[int], fullname: Optional[str],
                    is_inferred_def: bool, target_node: 'Optional[extyper.nodes.Node]' = None) -> str:
        n = name
        if is_inferred_def:
            n += '*'
        if target_node:
            ...
            id = ''
        if isinstance(target_node, extyper.nodes.MypyFile) and name == fullname:
            n += id
        elif kind == extyper.nodes.GDEF or (fullname != name and
                                         fullname is not None):
            # Append fully qualified name for global references.
            n += ' [{}{}]'.format(fullname, id)
        elif kind == extyper.nodes.LDEF:
            # Add tag to signify a local reference.
            n += ' [l{}]'.format(id)
        elif kind == extyper.nodes.MDEF:
    ...
    def visit_member_expr(self, o: 'extyper.nodes.MemberExpr') -> str:
        pretty = self.pretty_name(o.name, o.kind, o.fullname, o.is_inferred_def, o.node)
        return self.dump([o.expr, pretty], o)

    def visit_yield_expr(self, o: 'extyper.nodes.YieldExpr') -> str:
        return self.dump([o.expr], o)

    def visit_yield_from_expr(self, o: 'extyper.nodes.YieldFromExpr') -> str:
        if o.expr:
            return self.dump([o.expr.accept(self)], o)
        else:
            return self.dump([], o)

    def visit_call_expr(self, o: 'extyper.nodes.CallExpr') -> str:
        if o.analyzed:
            return o.analyzed.accept(self)
        args: List[extyper.nodes.Expression] = []
        extra: List[Union[str, Tuple[str, List[Any]]]] = []
        for i, kind in enumerate(o.arg_kinds):
            if kind in [extyper.nodes.ARG_POS, extyper.nodes.ARG_STAR]:
                args.append(o.args[i])
                if kind == extyper.nodes.ARG_STAR:
                    extra.append('VarArg')
            elif kind == extyper.nodes.ARG_NAMED:
    ...
    def visit_op_expr(self, o: 'extyper.nodes.OpExpr') -> str:
        return self.dump([o.op, o.left, o.right], o)

    def visit_comparison_expr(self, o: 'extyper.nodes.ComparisonExpr') -> str:
        return self.dump([o.operators, o.operands], o)

    def visit_cast_expr(self, o: 'extyper.nodes.CastExpr') -> str:
        return self.dump([o.expr, o.type], o)

    def visit_reveal_expr(self, o: 'extyper.nodes.RevealExpr') -> str:
        if o.kind == extyper.nodes.REVEAL_TYPE:
            return self.dump([o.expr], o)
        else:
            # REVEAL_LOCALS
            return self.dump([o.local_nodes], o)

    def visit_assignment_expr(self, o: 'extyper.nodes.AssignmentExpr') -> str:
        return self.dump([o.target, o.value], o)

    def visit_unary_expr(self, o: 'extyper.nodes.UnaryExpr') -> str:
        return self.dump([o.op, o.expr], o)

    def visit_list_expr(self, o: 'extyper.nodes.ListExpr') -> str:
        return self.dump(o.items, o)

    def visit_dict_expr(self, o: 'extyper.nodes.DictExpr') -> str:
        return self.dump([[k, v] for k, v in o.items], o)

    def visit_set_expr(self, o: 'extyper.nodes.SetExpr') -> str:
        return self.dump(o.items, o)

    def visit_tuple_expr(self, o: 'extyper.nodes.TupleExpr') -> str:
        return self.dump(o.items, o)

    def visit_index_expr(self, o: 'extyper.nodes.IndexExpr') -> str:
        if o.analyzed:
            return o.analyzed.accept(self)
        return self.dump([o.base, o.index], o)

    def visit_super_expr(self, o: 'extyper.nodes.SuperExpr') -> str:
        return self.dump([o.name, o.call], o)

    def visit_type_application(self, o: 'extyper.nodes.TypeApplication') -> str:
        return self.dump([o.expr, ('Types', o.types)], o)

    def visit_type_var_expr(self, o: 'extyper.nodes.TypeVarExpr') -> str:
        import extyper.types

        a: List[Any] = []
        if o.variance == extyper.nodes.COVARIANT:
            a += ['Variance(COVARIANT)']
        if o.variance == extyper.nodes.CONTRAVARIANT:
            a += ['Variance(CONTRAVARIANT)']
        if o.values:
            a += [('Values', o.values)]
        if not extyper.types.is_named_instance(o.upper_bound, 'builtins.object'):
            a += ['UpperBound({})'.format(o.upper_bound)]
        return self.dump(a, o)

    def visit_paramspec_expr(self, o: 'extyper.nodes.ParamSpecExpr') -> str:
        import extyper.types
    ...
    def visit_type_alias_expr(self, o: 'extyper.nodes.TypeAliasExpr') -> str:
        return 'TypeAliasExpr({})'.format(o.type)

    def visit_namedtuple_expr(self, o: 'extyper.nodes.NamedTupleExpr') -> str:
        return 'NamedTupleExpr:{}({}, {})'.format(o.line,
                                                  o.info.name,
                                                  o.info.tuple_type)

    def visit_enum_call_expr(self, o: 'extyper.nodes.EnumCallExpr') -> str:
        return 'EnumCallExpr:{}({}, {})'.format(o.line, o.info.name, o.items)

    def visit_typeddict_expr(self, o: 'extyper.nodes.TypedDictExpr') -> str:
        return 'TypedDictExpr:{}({})'.format(o.line,
                                             o.info.name)

    def visit__promote_expr(self, o: 'extyper.nodes.PromoteExpr') -> str:
        return 'PromoteExpr:{}({})'.format(o.line, o.type)

    def visit_newtype_expr(self, o: 'extyper.nodes.NewTypeExpr') -> str:
        return 'NewTypeExpr:{}({}, {})'.format(o.line, o.name,
                                               self.dump([o.old_type], o))

    def visit_lambda_expr(self, o: 'extyper.nodes.LambdaExpr') -> str:
        a = self.func_helper(o)
        return self.dump(a, o)

    def visit_generator_expr(self, o: 'extyper.nodes.GeneratorExpr') -> str:
        condlists = o.condlists if any(o.condlists) else None
        return self.dump([o.left_expr, o.indices, o.sequences, condlists], o)

    def visit_list_comprehension(self, o: 'extyper.nodes.ListComprehension') -> str:
        return self.dump([o.generator], o)

    def visit_set_comprehension(self, o: 'extyper.nodes.SetComprehension') -> str:
        return self.dump([o.generator], o)

    def visit_dictionary_comprehension(self, o: 'extyper.nodes.DictionaryComprehension') -> str:
        condlists = o.condlists if any(o.condlists) else None
        return self.dump([o.key, o.value, o.indices, o.sequences, condlists], o)

    def visit_conditional_expr(self, o: 'extyper.nodes.ConditionalExpr') -> str:
        return self.dump([('Condition', [o.cond]), o.if_expr, o.else_expr], o)

    def visit_slice_expr(self, o: 'extyper.nodes.SliceExpr') -> str:
    ...
    def visit_backquote_expr(self, o: 'extyper.nodes.BackquoteExpr') -> str:
        return self.dump([o.expr], o)

    def visit_temp_node(self, o: 'extyper.nodes.TempNode') -> str:
...
def dump_tagged(nodes: Sequence[object], tag: Optional[str], str_conv: 'StrConv') -> str:
    ...
    """
    from extyper.types import Type, TypeStrVisitor
    ...
    for n in nodes:
        if isinstance(n, list):
            ...
            a.append(indent(s, 2))
        elif isinstance(n, extyper.nodes.Node):
