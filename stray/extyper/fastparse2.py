...
from extyper.sharedparse import (
...
from extyper.reachability import mark_block_unreachable
...
try:
    ...
    from extyper.fastparse import ast3, ast3_parse
except ImportError:
    try:
