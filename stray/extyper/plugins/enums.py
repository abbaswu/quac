...
from extyper.types import Type, Instance, LiteralType, CallableType, ProperType, get_proper_type
...
def enum_name_callback(ctx: 'extyper.plugin.AttributeContext') -> Type:
...
def _infer_value_type_with_auto_fallback(
        ctx: 'extyper.plugin.AttributeContext',
...
def enum_value_callback(ctx: 'extyper.plugin.AttributeContext') -> Type:
