...
def _get_bytes_type(api: 'extyper.plugin.CheckerPluginInterface') -> Instance:
...
def _get_text_type(api: 'extyper.plugin.CheckerPluginInterface') -> Instance:
...
def _find_simplecdata_base_arg(tp: Instance, api: 'extyper.plugin.CheckerPluginInterface'
                               ) -> Optional[ProperType]:
...
def _autoconvertible_to_cdata(tp: Type, api: 'extyper.plugin.CheckerPluginInterface') -> Type:
...
def array_constructor_callback(ctx: 'extyper.plugin.FunctionContext') -> Type:
...
def array_getitem_callback(ctx: 'extyper.plugin.MethodContext') -> Type:
...
def array_setitem_callback(ctx: 'extyper.plugin.MethodSigContext') -> CallableType:
...
def array_iter_callback(ctx: 'extyper.plugin.MethodContext') -> Type:
...
def array_value_callback(ctx: 'extyper.plugin.AttributeContext') -> Type:
...
def array_raw_callback(ctx: 'extyper.plugin.AttributeContext') -> Type:
