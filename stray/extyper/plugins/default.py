...
from extyper.nodes import Expression, StrExpr, IntExpr, DictExpr, UnaryExpr
from extyper.plugin import (
    Plugin, FunctionContext, MethodContext, MethodSigContext, AttributeContext, ClassDefContext,
    CheckerPluginInterface,
)
from extyper.plugins.common import try_getting_str_literals
...
from extyper.checkexpr import is_literal_type_like
...
class DefaultPlugin(Plugin):
    ...
    def get_function_hook(self, fullname: str
        ...
        from extyper.plugins import ctypes, singledispatch
    ...
    def get_attribute_hook(self, fullname: str
        ...
        from extyper.plugins import ctypes
        from extyper.plugins import enums
    ...
    def get_class_decorator_hook(self, fullname: str
        ...
        from extyper.plugins import attrs
        from extyper.plugins import dataclasses
        from extyper.plugins import functools
