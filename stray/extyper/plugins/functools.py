...
from extyper.nodes import ARG_POS, ARG_STAR2, Argument, FuncItem, Var
from extyper.plugins.common import add_method_to_class
from extyper.types import AnyType, CallableType, get_proper_type, Type, TypeOfAny, UnboundType
...
def functools_total_ordering_maker_callback(ctx: extyper.plugin.ClassDefContext,
...
def _analyze_class(ctx: extyper.plugin.ClassDefContext) -> Dict[str, Optional[_MethodInfo]]:
