...
if TYPE_CHECKING:
    from extyper.build import Graph, State
...
def semantic_analyze_target(target: str,
    ...
    for dep in analyzer.imports:
        ...
        priority = extyper.build.PRI_LOW
