...
def mat(data, dtype=...): ...
def max(a, axis=..., out=..., keepdims=..., initial=..., where=...)->ndarray: ...
def min(a, axis=..., out=..., keepdims=..., initial=..., where=...)->ndarray: ...
def product(*args, **kwargs)->ndarray: ...
...
class _ArrayOrScalarCommon:
    ...
    def __eq__(self, other)->_ArraySelf: ...
    def __ne__(self, other): ...
    def astype(
        self: _ArraySelf,
        dtype: DTypeLike,
...
class ndarray(_ArrayOrScalarCommon, Generic[_ShapeType, _DType_co]):
    ...
    @overload
    def __sub__(self: NDArray[Any], other: _ArrayLikeObject_co) -> ndarray: ...
    # @overload
    # def __sub__(
    #     self: NDArray[Union[bool_, number[Any], timedelta64, datetime64]],
    #     other: _RecursiveSequence,
    ...
    @overload
    def __or__(self: NDArray[Any], other: _ArrayLikeObject_co) -> ndarray: ...
    # @overload
    # def __or__(
    #     self: NDArray[Union[bool_, integer[Any]]],
    #     other: _RecursiveSequence,
